...
class BookTest {
    ...
    void setNbPage() {
        Book b1 = new Book("Harry Potta", "JK", "Personne ne sait", 150);
        b1.setPageNb(800);
        assertEquals(800, b1.getPageNb());
    }

    @org.junit.jupiter.api.Test
    void testToString() {
        Book b1 = new Book("Harry Potta", "JK", "Personne ne sait", 150);
        assertEquals("Book{title='Harry Potta', author='JK', editor='Personne ne sait', pageNb=150}", b1.toString());
    }
}